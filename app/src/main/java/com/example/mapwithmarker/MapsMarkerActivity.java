...
public class MapsMarkerActivity extends AppCompatActivity
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng presidecia = new LatLng(27.1303901, -104.923825 );
        ...
        LatLng regist = new LatLng(27.1292776, -104.9243775 );
        ...
        googleMap.addMarker(new MarkerOptions().position(presidecia)
                .title("Presidecia"));
        googleMap.addMarker(new MarkerOptions().position(dif)
                .title("Dif"));


        googleMap.moveCamera(CameraUpdateFactory.newLatLng(presidecia));
    }
}
